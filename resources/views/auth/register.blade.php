    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3 text-center m-t-100">
            ...
            <h5> {{ trans('app.registertext') }}</h5>
                <hr>
            <a class="botton-default botton" href="{{ route('register.company') }}" role="button">{{ trans('app.entity') }}</a>
            <a class="botton-default botton" href="{{ route('register.user') }}" role="button">{{ trans('app.individual') }}</a>
