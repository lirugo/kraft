    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 m-t-20">
                ...
                <h3 class="text-primary">Просчет Т-профиля</h3>
                ...
                <h3 class="text-primary">Просмотр заказа и выписка счета</h3>
                ...
                <h3 class="text-primary">Калькулятор грильято </h3>
                ...
                <h3 class="text-primary">Калькулятор рейка KRAFT Куб</h3>
