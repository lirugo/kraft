        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <p>
                    ...
                    <strong>Представитель генерального подрядчика:</strong> {{ $object->delegatebuildersurname." ".$object->delegatebuildername." ".$object->delegatebuildpatronymic." тел.".$object->delegatebuilderphone }}<br>
                </p>
                <p>
