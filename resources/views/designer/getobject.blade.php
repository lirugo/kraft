    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                {!! Form::label(trans('app.Regional Manager'),$object->rmuser->patronymic." ".$object->rmuser->name) !!}
                <br>
                {{trans('app.Phone RM')}}
            ...
            <div class="col-md-4">
                ...
                {!! Form::label(trans('app.Date registration'), Carbon\Carbon::parse($object->created_at)->format('d.m.Y')) !!}
                <br>
                ...
                {!! Form::label(trans('app.Date Activation'), empty($object->dateofactivate) ? " " : Carbon\Carbon::parse($object->dateofactivate)->format('d.m.Y')) !!}
                <br>
                <p>
                    @php
                ...
                <p>
                    ...
                    {!! Form::label(trans('app.Date Next Report'), empty($object->reports->last()->dateofreport) ? " " : Carbon\Carbon::parse($object->reports->last()->dateofreport)->format('d.m.Y')) !!}
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <p>
                    ...
                    <strong>{{trans('app.Representative of the general contractor')}}:</strong> {{ $object->delegatebuildername." ".trans('app.phone').$object->delegatebuilderphone }}<br>
                </p>
                <p>
                    <strong>{{trans('app.Subcontractor')}}:</strong> {{ $object->subbuildername." ".trans('app.phone').$object->subbuilderphone  }}<br>
                    <strong>{{trans('app.Architecture')}}:</strong> {{ $object->archname." ".trans('app.phone').$object->archphone  }}<br>
                    <strong>{{trans('app.Design')}}:</strong> {{ $object->designname." ".trans('app.phone').$object->designphone  }}<br>
                </p>
                <p>
