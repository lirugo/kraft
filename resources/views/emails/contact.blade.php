        ...
        <tr>
            <td class="esd-email-paddings" valign="top">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-p25t es-p25b es-p10r es-p10l" align="center">
                                                                <a href="" target="_blank"><img src="{{asset('/img/logo/logo.png')}}" alt="" style="display: block;" width="200"></a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center">
                    <tbody>
                    <tr>
                        <td class="esd-stripe" style="background-color: rgb(236, 109, 100);" esd-custom-block-id="6340" bgcolor="#ec6d64" align="center">
